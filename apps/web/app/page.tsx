  ...
  return (
    <main className="site-shell">
      <nav className="top-nav">
        <Link className="site-brand" href="/" aria-label="Common Ground Creative home"><Image src="/brand/common-ground-creative-master-logo.png" alt="Common Ground Creative" width={1774} height={887} priority /></Link>
      ...
      <footer><Link className="footer-logo" href="/" aria-label="Common Ground Creative home"><Image src="/brand/common-ground-creative-master-logo.png" alt="Common Ground Creative" width={1774} height={887} /></Link><p>Built for brands entering Australia.</p><p>© 2026 Common Ground Creative</p></footer>
    </main>
  );
}
